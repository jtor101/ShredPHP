...
$("#submitBtn").on("click",function(){let isOk=inputVal();if(isOk==!1){return}else{confirm("Are you sure you want to register this band?");$.post("api/teams",$("#registerTeam").serialize());alert("Band registered!")}})})